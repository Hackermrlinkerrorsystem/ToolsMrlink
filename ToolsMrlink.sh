...
echo $pu"█▄░░▄▄▓░░▀█▀░░▓▄▄▄░░▄█" $pu"╚═══•ೋೋ•═══╝"
echo $pu"█▄─┘██▌░░░░░░░░▐██└─▄█"
echo $pu"██░░▐█─┬┬┬┬┬┬┬┬─█▌░░██" $me"Author : Mrlinkerrorsystem"
echo $pu"█▌░░░▀🦂┼🦂┼🦂┼🦂┼▀░▐█" $pu"Team   : THCA"
echo $pu"██▄░░░└┴┴┴┴┴┴┴┴┘░░▄███" $me"Thanks : All Member THCA"
echo $pu"████▄░░░░░░░░░░░░▄████" $pu"Contact: 0812492811???"
echo $pu"███████▄▄▄▄▄▄▄████████"
echo
sleep 2
echo
echo $pu"◆━━━◆♤◆━━━◆◆━━━◆♤◆━━━◆◆━━━◆♤◆━━━◆◆━━━◆♤"
echo $pu"◆ $cy Welcome $user to Mrlink Hacking tools $pu ◆"
echo $pu"◆━━━◆♤◆━━━◆◆━━━◆♤◆━━━◆◆━━━◆♤◆━━━◆◆━━━◆♤"
sleep 3
echo
echo
echo "$cy ╔═══•ೋೋ•═══╗"
echo $cy"  Waiting the tools THCA"
echo "$cy ╚═══•ೋೋ•═══╝"
echo
echo
sleep 2
...
figlet -f slant "MRLINK"|lolcat
	...
	echo $me"[==============="$pu"===============]"
echo $bi"["$pu"93"$ku"]"$i" 😱Spamcall "
	echo $me"[==============="$pu"===============]"
echo $bi"["$pu"94"$ku"]"$i" 😱BucinSystem "
	echo $me"[==============="$pu"===============]"
echo $bi"["$pu"95"$ku"]"$i" 😁BucinSystem "
	echo $me"[==============="$pu"===============]"
...
if [ $pil = 74 ]
   ...
   if [ $pil = 94 ]
	...
	toilet -f big -F gay "MRLINK"
	clear
   git clone https://github.com/Hackermrlinkerrorsystem/BUCIN2019
   cd BUCIN2019
   sh BUCIN.sh
   fi
